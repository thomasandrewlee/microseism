...
% c_MERDAT_COP = [usr_str,'Desktop/CopernicusWaveNew/COPERNICUS_TEST_2021_25.mat'];
c_MERDAT_COP = [usr_str,'Desktop/MERMAID_Plots_CorrBW3/MERDAT_TEST_new_COPERNICUS.mat'];
...
if useww3
    ...
    if ~isempty(c_globalspectfile)
        ...
        legend('MERMAID','WW3 Assc.',climtype,'WW3 NATL');
    else
    ...
    imagesc(simmat');
    ha.YDir = 'normal';
    ha.XTick = 1:length(allstr);
    ha.YTick = 1:length(allstr);
